...
local function draw()
  ...
  if page == "main" then
    ...
    term.setTextColor(theme.main.textBold)
    term.write("Settings")
    drawSubmenu("Personalization", "Change the look of Wrench", 4)
    if ccemux then
  ...
  elseif page == "personalization" then
    ...
    drawSubmenu("Theme", "Change Wrench's look system-wide", 4)
  ...
  if e[1] == "mouse_click" then
    ...
    if m == 1 then
      if y >= 4 and y <= 5 and page == "main" then
        drawSubmenu("Personalization", "Change the look of Wrench", 4, true)
      ...
      elseif y >= 4 and y <= 5 and page == "personalization" then
        drawSubmenu("Theme", "Change Wrench's look system-wide", 4, true)
